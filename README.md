...
- [DeepThought](https://github.com/ryanr08/DeepThought/labels/good%20first%20issue) _(label: good first issue)_ <br> DeepThought is an algorithmic cryptocurrency trading bot.
